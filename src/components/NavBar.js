      ...
      <div className="navigation">
        ...
        <div className="flex justify-center items-center">
          <div className="social-icons">
            <a><img src={ location.pathname === "/" ? imageSrc.icons.discord : imageSrc.icons.discordLight} alt="discord"/></a>
            <a><img src={ location.pathname === "/" ? imageSrc.icons.twitter : imageSrc.icons.twitterLight } alt="twitter"/></a>
          </div>
